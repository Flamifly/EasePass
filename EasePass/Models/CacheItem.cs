...
namespace EasePass.Models
{
    internal class CacheItem
    {
        ...
        public static CacheItem FindInCache(string category, ReadOnlySpan<char> id)
        {
        ...
        public static CacheItem Create(string category, ReadOnlySpan<char> id, bool reserve = false)
        {
            CacheItem item = new CacheItem();
            item.Category = category;
            item.Id = CalculateHash(id);
        ...
        private static string CalculateHash(ReadOnlySpan<char> read)
        {
